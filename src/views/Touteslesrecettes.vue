        ...
        <div class="Groupe2" style="font-size: 30px">
          ...
          <div>
            <b-card-group columns>
              <touteslesrecettes v-for="item in this.recette"
...
import touteslesrecettes from '../components/touteslesrecettes.vue'
    ...
    let recette = [
...

      {
        ...
        preparation:
          ...
          "Plongez-les dans une bassine d'eau froide.\n\n "+
          "Laissez-les tremper pendant la préparation de votre plat à gratin.\n\n" +
      ...
      {
        titre: "RECETTE SALADE DE QUINOA ET DE LEGUMES (SANS GLUTEN)",
        paragraphe:
          "Decouvrez la Savoureuse recette salade de quinoa \n\n"+
          "La fraîcheur de cette salade d'accompagnement colorée\n\n"+ 
          "composée de quinoa et de nombreux légumes \n\n"+
          "Recette pour 4 personnes\n\n" +
          "Temps de préparation 20 minutes\n\n" +
          "Temps de cuisson 40 minutes\n\n",
        image: "images/recette-salade.jpg",
        ingredient:
        ...
        preparation:
          "Rincer le quinoa à l'eau froide pendant 1 minute ; égoutter.\n\n "+
          "Faire cuire le quinoa en suivant les directives sur l'emballage ;\n\n"+
          "égoutter. Laisser refroidir complètement, environ 30 minutes.\n\n"+
          "Entre-temps, dans un petit bol non métallique, mettre le jus de citron,\n\n"+
          "l'huile et le basilic ; bien mélanger. Réserver pour la vinaigrette.\n\n"+
          "Dans un grand bol, mélanger délicatement le quinoa, les haricots, le maïs,\n\n"+
          "les tomates, le poivron et les olives. Verser la vinaigrette sur le mélange de quinoa ;\n\n "+
          "remuer délicatement pour enrober. Servir immédiatement ou réfrigérer durant 1 ou 2 heures avant de servir.\n\n"+
          "Juste avant de servir, parsemer de fromage. Garnir de feuilles de basilic si désiré.",
      },

      
      {
        titre: "SALADE AFRICAINE"+
         "DELICIEUSEMENT EXOTIQUE !\n\n",
        paragraphe:
          "Une salade originale et savoureuse pour un voyage culinaire\n\n"+
         "délicieusement exotique !\n\n",
        image: "images/salade-africaine.jpeg",
        ingredient:
          "1 jaune d’œuf\n\n"+
          ...
          "1 citron vert\n\n"+
          "2 avocats bien mûrs\n\n"+
          "1 petite boîte de miettes de thon (environ 100 g)\n\n"+
          "1 boîte de cœurs de palmier (environ 400 g)\n\n"+
          "de noix de coco fraîche\n\n"+
          "1 c. à café de persil haché\n\n"+
          "1 pointe de piment de Cayenne\n\n"+
          "sel fin et poivre noir du moulin\n\n",
         preparation:
          " Coupez le citron en deux puis pressez-le pour en recueillir le jus.\n\n"+
          "Dans un bol, fouettez le jaune d’œuf avec la moutarde. Salez et poivrez à votre convenance.\n\n"+
          "Versez l’huile en filet sans cesser de fouetter jusqu’à obtenir une mayonnaise onctueuse et bien ferme.\n\n"+
          "Agrémentez-la de persil haché, de jus de citron vert et de piment de Cayenne. Rectifiez l’assaisonnement si nécessaire.\n\n"+
          "Couvrez votre bol avec du film alimentaire et réservez votre mayonnaise au réfrigérateur.\n\n"+
          "Égouttez soigneusement les cœurs de palmiers puis débitez-les en tronçons.\n\n"+
          "Coupez les avocats en deux, ôtez les noyaux et enlevez la peau. Détaillez ensuite la chair d’avocat en petits dés.",
      },


       {
        titre: "CAPITAINE FARCIE AUX EPINARDS",
        paragraphe:
          "Recette pour 4 personnes\n\n" +
          "Temps de préparation 20 minutes\n\n" +
          "Temps de cuisson 40 minutes\n\n",
        ...
        ingredient:
          "1 poisson capitaine de 2 kg \n\n" +
           ...
           "4 gousses d'ail \n\n" +
           "1 pincée de tamoutamou (curcuma)\n\n"+ 
           "1 cuillère à café de coriandre.\n\n",
        preparation:
          "1. Écailler, vider et nettoyer le poisson \n\n" +
           "2. Faire quatre incisions sur les deux côtés du poisson \n\n" +
           "3. Pendant que le poisson repose, couper l'oignon en rondelle, émincez les deux gousses d'ail et une tomate."+
          "4. Mettre au fond du plat. et ajouter une cuillère à soupe d'huile."+
          "5. Farcir le poisson avec la pâte d'épice et deux tomates découpées en petits morceaux."+
          "6. Disposer dans le plat, arroser-le de jus de citron et râpez un peu de combava par dessus."+
          "7. Et Concernant le combava, mettre la moitié d'une cuillère à café. Ne pas en mettre beaucoup, sinon il prend toute l'odeur du plat"+
          "8. Verser deux cuillères à soupe d'huile sur le poisson et mettre la moitié d'un grand verre d'eau.",
      },
...

     {
      ...
      {
        titre:
          "POMMES DE TERRES ET GAMBAS CUITES DANS UNE SAUCE TOMATE EPICEE AU BASILIC",
        paragraphe:
      ...
      },
      {
        ...
        paragraphe:
          ...
          "Trop gourmands pour attendre ? Les autres, optant pour le plus épais (Fideo gordo).\n\n"+ 
          "l'apprécient car ce vermicelle est creux,\n\n" +
          "le fumet pénètre mieux et reste à l'intérieur ; un éclatement des saveurs en bouche.\n\n"+
          "Il demande plus de fumet et un peu plus de cuisson. A vous de choisir ! .",
        image: "images/recette-de-la-paella.jpg",
        ingredient:
          "700 g de calamars \n\n " +
          ...
          "Dans la paella faites cuire les crevettes ou gambas,\n\n"+
          "les langoustines dans de l'huile d'olive bien chaude.\n\n" +
          "Réservez-les. Dans la même huile faites rissoler le calamar coupé en morceaux,\n\n"+
          "les tomates pelées et concassées,\n\n"+
          "le poivron en lanières et l'ail haché. Faites réduire à feu doux.\n\n"+
          "Versez le fumet, quand il commence à bouillir ajoutez les vermicelles,\n\n"+
          "répartissez-les bien sur l'ensemble de la paella.\n\n"+
          "Saupoudrez d'une bonne pincée de safran et laissez mijoter environ 6 minutes puis déposez les coquillages nettoyés,\n\n"+
          "les crevettes, gambas, langoustines.\n\n" +
          "Laissez cuire au moins 15 minutes, le bouillon doit s'être évaporé.\n\n"+
          "Retirez votre paella du feu et laissez reposer 5 minutes pour que les vermilles\n\n"+
          "s'imprègnent du bouillon de cuisson.\n\n" +
          "Ce qui rend ces petites pâtes spéciales et goûteuses, c'est qu'on les fait griller à sec dans une poêle,\n\n"+
          "en plusieurs lots, avant de les faire cuire dans un liquide.\n\n" +
        ...
        preparation:
          ...
          "Coupez l'oignon et les carottes en morceaux ajoutez-les.\n\n"+
          "dans la casserole avec les feuilles de laurier et le sel.\n\n" +
          "Recouvrez d'eau et assaisonnez. Portez à ébullition.\n\n"+ 
          "Une mousse peut apparaître, pas de panique, c'est normal, écumez-la.\n\n" +
      ...
      },
      {
        ...
        paragraphe:
          " Bonjour mes amour j'espère que vous allez bien,\n\n"+
          " et que le week-end à très bien débuté.\n\n" +
      ...
      {
        titre: "SPAGHETTI A L ITALIENNE",
        paragraphe:
          "Découvrez cette recette a vous couper le souffle.\n\n",
        image: "images/poulet-a-la-sauce-tomate.jpeg",
        ingredient:
          "Nombre de personnes: 4\n\n"+
          "350 g de boeuf haché cru.\n\n"+
          "2 tranches de pain de mie\n\n"+
          "3 cuil. à soupe de lait\n\n"+
          "1 oeuf\n\n"+
          "Quelques tours de moulin moulin herbes italiennes\n\n"+
          "Quelques tours de moulin Moulin 5 baies - Doux\n\n"+
          "Quelques tours de moulin Moulin à sel de Camargue\n\n"+
          "400 g de tomates concassées ou coulis de tomates\n\n"+
          "1/2 verres d'eau\n\n"+
          "250 g de spaghetti crus",
        preparation:
          "Fouettez le lait avec l’œuf dans un saladier, ajoutez le pain pour qu’il s’imbibe puis émiettez-le\n\n"+ 
          "Salez et poivrez bien. Ajoutez la viande, puis saupoudrez généreusement d’herbes italiennes au moulin\n\n"+
          "Malaxez soigneusement, puis formez 12 boulettes\n\n"+
          "Faites cuire les pâtes comme indiqué sur le sachet.\n\n"+
          "Pendant ce temps, faites dorer les boulettes dans une poêle chaude avec un peu d’huile.\n\n"+
          "Ajoutez les tomates et l’eau, salez, poivrez, ajoutez quelques tours de moulin herbes italiennes\n\n"+
          "puis couvrez et laissez mijoter 6-8 minutes.\n\n"+
          "Egouttez les pâtes, répartissez dans les assiettes puis ajoutez viande et sauce. Dégustez.",
      },

      {
        ...
        preparation:
          ...
          "Une fois écrasée ajoutez y la tomate concentrée et deux cubes d’assaisonnements,\n\n"+
          "du poivre et un peu d’eau.\n\n" +
          "2) Lavez la feuille d'attiéké puis l’étaler dans la casserole,\n\n"+
          "ajoutez y les poissons puis les condiments écrasés.\n\n" +
          "Laissez mijoter au feu pendant 60min.\n\n"+
          "À défaut de la feuille d’attiéké vous pouvez utiliser du papier aluminium.\n\n" +
          "NB : Assurez vous de ne pas mettre assez d’eau car à la base le carpe est un poisson\n\n"+
          ...
          "1) Épluchez le manioc et les couper en morceaux assez moyen.\n\n"+
           "Épluchez aussi la banane, les fendre en deux et retirer l’intérieur qui contient les petits points noirs.\n\n" +
          "Mettez le manioc et la banane dans une casserole.\n\n "+
          "Assurez vous que le manioc soit en bas et les bananes au dessus.\n\n" +
          ...
          "1) Avec l’eau de cuisson du foutou recueilli ajoutez y les aubergines ainsi que les piments équeuter,\n\n"+
          "sans oublier les boules de tomates et un oignon.\n\n" +
...

      {
        ...
        paragraphe:"Épluchez et hachez l’oignon puis coupez les carottes en rondelles..\n\n"+
         "Dans une cocotte chauffez l’huile d’olive .\n\n"+
         "puis faites revenir l’oignon et les carottes pendant quelques minutes..\n\n"+
